...
for i in range(0, number_of_visualizations):
    ...
    axes[i][1].set_xlabel("PSNR: {0}".format(measure.PSNR(pure_image, noisy_image)))
    ...
    axes[i][3].set_ylabel("SSIM: {:.5f}".format(measure.get_image_ssim(pure_image, bm3d_denoised)))
    axes[i][4].imshow(nl_denoised, pyplot.cm.gray)
    axes[i][4].set_xlabel("PSNR: {0}".format(measure.PSNR(pure_image, nl_denoised)))
    axes[i][4].set_ylabel("SSIM: {:.5f}".format(measure.get_image_ssim(pure_image, nl_denoised)))
...
def save_samples(noisy_input_test, denoised_images, pure_test):
    ...
    for i in range(0, len(noisy_input_test)):
        ...
        axes[0].set_xlabel("PSNR: {0}".format(measure.PSNR(pure_image, pure_image)))
        axes[0].set_ylabel("SSIM: {:.5f}".format(measure.get_image_ssim(pure_image, pure_image)))
        axes[1].imshow(noisy_image, pyplot.cm.gray)
        axes[1].set_xlabel("PSNR: {0}".format(measure.PSNR(pure_image, noisy_image)))
        axes[1].set_ylabel("SSIM: {:.5f}".format(measure.get_image_ssim(pure_image, noisy_image)))
        axes[2].imshow(denoised_image, pyplot.cm.gray)
        axes[2].set_xlabel("PSNR: {0}".format(measure.PSNR(pure_image, denoised_image)))
        ...
        axes[3].set_xlabel("PSNR: {0}".format(measure.PSNR(pure_image, bm3d_denoised)))
        axes[3].set_ylabel("SSIM: {:.5f}".format(measure.get_image_ssim(pure_image, bm3d_denoised)))
        axes[4].imshow(nl_denoised, pyplot.cm.gray)
        axes[4].set_xlabel("PSNR: {0}".format(measure.PSNR(pure_image, nl_denoised)))
